...
@Component({
  template: `   <div class='container'>
              ...
              <app-appontments-details [patient]="patient[0]" [singleAppointment]="singleAppointment" [appointments]="appointments" [allAppointments]="allAppointments" [doctor]="doctor[0]"></app-appontments-details>
              </div>
              </div>
              </div> `,
...
export class DoctorAppointmentsDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getLoginFromUrl()
      ...
      .then(() => this.getAllDoctorAppointments())
      .then(param => this.allAppointments = param)

...
export class DoctorAddComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.doctorAddForm = this.fb.group({
         ...
         this.doctorAddForm.get('password').valueChanges.subscribe(value => this.doctor.password = this.doctorAddForm.get('password').value);
         this.doctorAddForm.get('gender').valueChanges.subscribe(value => this.doctor.gender = this.doctorAddForm.get('gender').value);
